...
<template>
<div class="form-feedback" id="w-popup-01">
...
.form-feedback__group-input, input.form-feedback__group-input {
    background: 0 0;
...
.form-feedback__bottom-text, .form-feedback__bottom-text a {
    color: #88959c;
    font-size: 14px;
    font-weight: 400;
    line-height: 130%;
